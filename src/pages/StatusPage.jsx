...
const StatusPage = () => {
  ...
  const [addressValue, setAddressValue] = useState("https://status.alora.is-a.dev/");
  ...
  return (
    <div className="status-page min-h-screen pt-28 pb-20 px-5 md:px-10 lg:px-20">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-10">
          <h1 className="status-title text-3xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-green-400 via-blue-500 to-purple-400 text-transparent bg-clip-text animate-glow">
            System Status
          </h1>
          <p className="status-subtitle text-white-50 md:text-lg max-w-2xl mx-auto">
            Check the current status of all Alora services and systems.
          </p>
        </div>
            ...
            {isLoading && (
              <div className="absolute inset-0 flex flex-col items-center justify-center bg-black-100 z-10">
                <div className="flex space-x-2 items-center">
                  <div className="w-4 h-4 bg-gradient-to-r from-green-500 to-blue-500 rounded-full animate-bounce" style={{ animationDelay: '0s' }}></div>
                  ...
                  <div className="w-4 h-4 bg-gradient-to-r from-purple-500 to-green-500 rounded-full animate-bounce" style={{ animationDelay: '0.4s' }}></div>
                </div>
                <p className="mt-4 text-white-50">Loading status information...</p>
              </div>
            )}
            <iframe
              ref={iframeRef}
              src="https://status.alora.is-a.dev/"
              title="Alora's System Status"
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="card bg-black-200/70 border border-black-50 rounded-xl p-6 relative overflow-hidden backdrop-blur-sm">
            <div className="glow bg-gradient-to-r from-green-500/20 to-transparent"></div>
            <div className="relative z-10">
              <div className="w-12 h-12 mb-4 rounded-full bg-gradient-to-r from-green-500 to-blue-500 flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h3 className="text-xl font-semibold text-white mb-2">Real-time Status</h3>
              <p className="text-blue-50">Check the current operational status of all services and systems.</p>
            </div>
          </div>
          ...
          <div className="card bg-black-200/70 border border-black-50 rounded-xl p-6 relative overflow-hidden backdrop-blur-sm">
            ...
            <div className="relative z-10">
              ...
              <p className="text-blue-50">Monitor performance metrics and response times for all services.</p>
            </div>
          </div>
          ...
          <div className="card bg-black-200/70 border border-black-50 rounded-xl p-6 relative overflow-hidden backdrop-blur-sm">
            ...
            <div className="relative z-10">
              <div className="w-12 h-12 mb-4 rounded-full bg-gradient-to-r from-purple-500 to-green-500 flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h3 className="text-xl font-semibold text-white mb-2">Incident History</h3>
              <p className="text-blue-50">View past incidents and their resolutions with detailed timelines.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="fixed top-0 left-0 w-full h-full pointer-events-none z-0">
        ...
        <div className="absolute top-20 left-10 w-72 h-72 bg-green-500/5 rounded-full filter blur-3xl animate-float" style={{animationDuration: '8s'}}></div>
        <div className="absolute top-[30%] right-[20%] w-64 h-64 bg-blue-500/3 rounded-full filter blur-3xl animate-float" style={{animationDelay: '2s', animationDuration: '12s'}}></div>
        <div className="absolute bottom-20 right-10 w-80 h-80 bg-purple-500/5 rounded-full filter blur-3xl animate-pulse" style={{animationDuration: '10s'}}></div>
